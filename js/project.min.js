...
!function(t){"use strict";t('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var o=t(this.hash);if((o=o.length?o:t("[name="+this.hash.slice(1)+"]")).length)return t("html, body").animate({scrollTop:o.offset().top},1e3,"easeInOutExpo"),!1}}),t(".js-scroll-trigger").click(function(){t(".navbar-collapse").collapse("hide"),t("#menuModal").modal("hide")}),t("body").scrollspy({target:"#mainNav",offset:56}),t("form .form-control").focus(function(){t(this).prev().css("color","#00C2FF")}).blur(function(){t("form .form-control").prev().css("color","#ffffff")})}(jQuery);